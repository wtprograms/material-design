...
function mixinValue<TValue, T extends MixinBase<LitElement>>(
  ...
  base: T
): MixinReturn<T, Value<TValue>> {
  abstract class Mixin extends base implements Value<TValue> {
